...
const Footer = () => {
  ...
  const socialLinks = [
    { icon: FaGithub, href: "https://github.com/NazmusSakib2036" },
    // { icon: FaTwitter, href: "#" },
    { icon: FaLinkedin, href: "https://www.linkedin.com/in/md-nazmus-sakib-303345241/" },
    { icon: FaFacebook, href: "https://www.facebook.com/Nazmus.Sakib.41240102036" },
    { icon: FaInstagram, href: "https://www.instagram.com/nazmussakib2036/" },
    // { icon: FaYoutube, href: "#" },
  ];
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-center md:text-left">
            <div className="flex items-center justify-center gap-2 text-gray-600">
              ...
              <span className="text-sm sm:text-base">
                Made with love by <a href="https://www.nazmussakib.me" className="text-purple-600 hover:underline" target="_blank">Nazmus Sakib</a>
              </span>
            </div>
